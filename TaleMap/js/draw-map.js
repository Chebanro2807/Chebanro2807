...
async function drawMap() {
    ...
    xhr.send();*/
    /*let response = await fetch("https://the-tale.org/game/map/api/region?api_client=map-v0.4&api_version=0.1", {
        method: "GET",
    ...
    /*fetch("https://the-tale.org/game/map/api/region?api_client=map-v0.4&api_version=0.1", {mode: 'no-cors'})
